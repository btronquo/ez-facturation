...
<div class="wrapper" id="app">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" aria-expanded="false" href="{{ route('logout') }}"
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    Adapted by <strong>Boris Tronquoy</strong> | Powered by <strong>Laravel6</strong>, <strong>VueJS</strong>, <strong>MariaDB</strong> | Template by <strong><a href="https://adminlte.io">AdminLTE.io</a>.</strong>
  </footer>
</div>
<!-- ./wrapper -->
